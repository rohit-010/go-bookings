...
import (
	...
	"github.com/rohit-010/go-bookings/internal/forms"
	...
	"github.com/rohit-010/go-bookings/internal/repository"
	"github.com/rohit-010/go-bookings/internal/repository/dbrepo"
)

// Repo used by the handlers
var Repo *Repository

// Repository type to store repository details
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if !form.Valid() {
		...
		http.Error(w, "Not valid form", http.StatusSeeOther)
		render.Template(w, r, "make-reservation.page.tmpl", &models.TemplateData{
			Form: form,
			Data: data,
		})
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	//Removed error check as we handled all aspects of json
	out, _ := json.MarshalIndent(resp, "", "     ")
...
// BookRoom takes url params builds a session var and takes user to make-reserv screen
